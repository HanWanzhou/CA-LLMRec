...
if __name__ == "__main__":
    ...
    # dataset setting - 修正为完整的ultra_light数据集名称
    parser.add_argument("--rec_pre_trained_data", type=str, default='Movies_and_TV_ultra_light_1000u_3000i')
    ...
    # CA-LLMRec counterfactual options
    parser.add_argument("--enable_counterfactual", action='store_true', 
                       help='Enable counterfactual augmented training')
    parser.add_argument("--cf_alignment_weight", type=float, default=0.1,
                       help='Weight for counterfactual alignment loss')
    parser.add_argument("--cf_mask_ratio", type=float, default=0.2,
                       help='Mask ratio for counterfactual sequence generation')
